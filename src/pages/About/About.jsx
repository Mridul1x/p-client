...
const img4 =
  "https://res.cloudinary.com/dfilp24nj/image/upload/f_auto,q_auto/v1/agromart/v5j84y3uumd2qzqfbj4m";
const img3 =
  "https://res.cloudinary.com/dfilp24nj/image/upload/f_auto,q_auto/v1/agromart/eynfzfa234hwtbmfnhyx";
const img1 =
  "https://res.cloudinary.com/dfilp24nj/image/upload/f_auto,q_auto/v1/agromart/kizvyhzjwkcdjyyfxvxj";

const img5 =
  "https://res.cloudinary.com/dfilp24nj/image/upload/f_auto,q_auto/v1/agromart/s40yyzozv4xz8v8ovpqf";
  ...
  return (
    <main>
      <Helmet>
        ...
        <meta
          name="description"
          content="At AgroMart, we believe that snacking should be an experience that tantalizes the taste buds and nourishes the soul."
        />
        <meta
          name="keywords"
          content="AgroMart, premium nuts, healthy snacks, about us"
        />
        <link rel="canonical" href="https://www.agromart.com/about" />
      </Helmet>
      <section className="py-16 container mx-auto px-5 md:px-0">
        ...
        >
          <p className="text-xl ">
            At AgroMart, we believe that snacking should be an experience that
            tantalizes the taste buds and nourishes the soul. Our journey began
            with a simple yet profound love for nuts, seeds, and everything
            crunchy and delicious. What started as a humble family tradition of
            roasting nuts with care and attention to detail has now blossomed
            into a premier destination for nut enthusiasts worldwide. We take
            immense pride in sourcing only the finest quality nuts from trusted
            growers around the globe. From the rich soils of California to the
            exotic plantations of the Mediterranean, each nut in our collection
            is handpicked to ensure superior taste, texture, and freshness. Our
            commitment to quality means that every batch is carefully inspected
            to meet our rigorous standards before it reaches your doorstep.
          </p>
        </div>
        {/* image section */}
        <div
        ...
        >
          ...
          <p className="text-xl">
            At AgroMart, we invite you to embark on a culinary adventure where
            every bite is a celebration of flavor and quality. Our exquisite
            selection of premium nuts is carefully curated to delight your
            senses and satisfy your cravings. Indulge in the rich, buttery
        ...
        >
          <h1 className="text-3xl sm:text-5xl lg:text-7xl w-4/6 font-semibold leading-tight  sm:leading-tight lg:leading-tight">
            <span className="text-design-left relative">AgroMart</span> - 5
            Things we value
          </h1>
